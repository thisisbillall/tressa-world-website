...
VALUES
  ...
  ('102','Premium Room 102','Garden-view King','King premium comfort with a serene garden outlook and workspace.','Floor 1','King',320,2,
     4000,12,FALSE,0,NULL,
     ARRAY['King Bed','Smart TV','Free Wi-Fi','AC','Work Desk','Room Service'],
  ...
  ('106','Premium Room 106','City-view King','Family-friendly king layout with generous storage and a reading light.','Floor 2','King',320,3,
     4000,12,FALSE,0,NULL,
     ARRAY['King Bed','Smart TV','Free Wi-Fi','AC','Work Desk','Room Service'],
