...
const bookingFaqs = [
  ...
  { q: 'How much is the booking fee?', a: '₹99 per reservation. The full ₹99 is redeemed on your total booking at the venue, so you pay nothing extra to reserve. The 15% discount only applies in Exclusive windows.' },
